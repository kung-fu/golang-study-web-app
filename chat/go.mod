module github.com/kung-fu/golang-study-web-app/chat
...
require (
	...
	github.com/kung-fu/golang-study-web-app/trace v0.0.0-00010101000000-000000000000
...
replace github.com/kung-fu/golang-study-web-app/trace => ../trace
